...
fn get_vote_claim_from_token(vote_token: &str, opt: Option<VerificationOptions>) -> FieldResult<JWTClaims<VoteTokenClaim>> {
	let mut parts = vote_token.split('.');
	...
	let claims: JWTClaims<VoteTokenClaim> =
