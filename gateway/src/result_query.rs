...
pub struct RankingEntry {
	...
	/// 男性比例
	pub male_percentage_per_char: f32,
	/// 占总体男性比例
	pub male_percentage_per_total: f32,
	/// 女性票数
	pub female_vote_count: i32,
	/// 女性比例
	pub female_percentage_per_char: f32,
	/// 占总体女性比例
	pub female_percentage_per_total: f32,
	/// 趋势
